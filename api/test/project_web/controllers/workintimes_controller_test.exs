# defmodule TodolistWeb.WorkintimesControllerTest do
...
#   @create_attrs %{
#     end: ~U[2021-10-25 12:48:00Z],
#     start: ~U[2021-10-25 12:48:00Z]
#   }
#   @update_attrs %{
#     end: ~U[2021-10-26 12:48:00Z],
#     start: ~U[2021-10-26 12:48:00Z]
#   }
...
#       assert %{
#                "id" => ^id,
#                "end" => "2021-10-25T12:48:00Z",
#                "start" => "2021-10-25T12:48:00Z"
...
#       assert %{
#                "id" => ^id,
#                "end" => "2021-10-26T12:48:00Z",
#                "start" => "2021-10-26T12:48:00Z"
#              } = json_response(conn, 200)["data"]
#     end
